class API{
  // static const HOST_PATH = "http://192.168.1.102/clothes/backend";
  // static const HOST_PATH = "http://hgt-compra.000webhostapp.com/backend";
  static const HOST_PATH = "http://dar.great-site.net/backend/";
  
// image
  // static const IMAGE ="http://192.168.1.102/clothes/backend/";
  static const IMAGE ="http://dar.great-site.net/backend/";
  // static const IMAGE ="http://hgt-compra.000webhostapp.com/backend";
