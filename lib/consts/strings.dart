const appname = "Compra";
const appversion = "Version 1.1.0";
const credits = "Redgab";
const email = "Email";
...
const loggedinerror = "Email or Password incorrect";
...
const paypal = 'Paypal', cod = 'Cash on delivery', stripe = "Stripe";
